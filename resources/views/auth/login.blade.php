...
@php
    ...
    $site_name = App\Models\Setting::where('key', 'project_name')->first()->value ?? null;
@endphp
...
<head>
    ...
    <title>{{ $site_name ?? 'Campaign' }}</title>
                ...
                <div class="w-px-400 mx-auto">
                    ...
                    <div class="app-brand mb-4">
                        <a href="index.html" class="app-brand-link gap-2">
                            @if ($logo)
                                <img src="{{ asset('storage/' . $logo) }}" class="app-brand-logo" alt="logo"
                                    width="100px" />
                            @else
                    ...
                    <!-- /Logo -->
                    <h3 class="mb-1">Welcome to {{ $site_name ?? 'Campaign' }}! 👋</h3>
